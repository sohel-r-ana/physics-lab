...
//  <br>  U = ${vU} <br> a = ${va} <br> t = ${vt}`;
 ...
 if(ss.checked   && vv==false)
 {
    ...
    there you want to know S = ? <br><br>
    there ruls number 3  is <br>
     S = Ut +  1/2 at &#xb2 <br>
 ...
 else if(ss.checked  && va==false)
 {
    ...
    you want to know S =?<br> <br> there ruls number 2 is <br>
 ...
 else if( ss.checked  && vt==false )
 {
     ...
     math.innerHTML=`a object starts at a speed of ${vU} m/s <br>
       ...
       you want to know S =?<br> <br> there ruls number 4 is <br>
      v &#xb2 = U &#xb2 + 2aS <br>
     => v &#xb2 - U &#xb2 = 2aS <br>
 ...
 else if(vvv.checked && vs==false )
 {
    var vU2 = Number(vU);
     ...
     math.innerHTML=`a object starts at a speed of ${vU} m/s <br>
       it is move with ${va} m/s&#xb2  Acceleration <br>
       It lasts for ${vt} second <br>
      you want to know V =?<br> <br> there ruls number 1 is <br>
      v = U + at <br>
     => v = ${vU} + ( ${va} ✕ ${vt} )<br>
     => v = ${vU} + ${vat} <br>
     => v = ${ans} m/s <br>
 ...
 else if(vvv.checked && va==false)
 {
     ...
     It lasts for ${vt} second <br>
      you want to know V =?<br> <br> there ruls number 2 is <br>
      S = |v-U| / 2 * t <br>
      => v - U = 2S / t<br>
      => v = (2S / t) + U<br>
     => v =( 2✕${vs} /  ${vt}) + ${vU} <br>
 ...
 else if( vvv.checked && vt==false )
 {
     ...
     math.innerHTML=`a object starts at a speed of ${vU} m/s <br>
      ...
      you want to know V =?<br> <br> there ruls number 4 is <br>
      v &#xb2 = U &#xb2 + 2aS <br>
 ...
 else if( uu.checked && vs==false )
 {
     ...
     math.innerHTML=`a object starts at a speed of ${vU} m/s <br>
      it is move with  ${va} m/s &#xb2 Acceleration <br>
      It lasts for ${vt} second <br>
      you want to know U =?<br> <br> there ruls number 1 is <br>
      v = U + at <br>
      => U = v - at <br> 
      => U = ${vv} - ( ${va} ✕ ${vt} ) <br> 
     => U = ${vv} - ${vat}  <br>
 ...
 else if( uu.checked && va==false )
 {
     ...
     It lasts for ${vt} second <br> 
      you want to know U =?<br> <br> there ruls number 2 is <br>
      S = (v-U)/2 ✕ t <br>
      => S/t = (v-U)/2 <br> 
      => 2S/t = v-U <br> 
      => (2S/t)-v = -U <br> 
 ...
 else if(uu.checked && vv==false )
 {
     ...
     math.innerHTML=`a object  is travels ${vs} miter <br>
       ...
       It lasts for ${vt} second <br>
      you want to know U =?<br> <br> there ruls number 3 is <br>
      S = Ut + ½ at&#xb2  <br>
      =>Ut =S - ½at&#xb2 <br> 
      => U = (S - ½at&#xb2)/ t <br> 
 ...
 else if( uu.checked && vt==false )
 {
     ...
     math.innerHTML=`a object is travels for  ${vs} miter <br>
      ...
      you want to know U =?<br> <br> there ruls number 4 is <br>
      v&#xb2 = U&#xb2 + 2as<br>
      => v&#xb2 - 2aS = U&#xb2  <br> 
      => U&#xb2 = v&#xb2 - 2aS <br> 
 ...
 else if(tt.checked && vs==false )
 {
     ...
     it move with ${va} m/s&#xb2 Acceleration <br>
      at last it take  ${vv} m/s speed <br>
      you want to know t =?<br> <br> there ruls number 1 is <br>
      v = U + at <br>
      =>at = v - U  <br> 
      =>t = ( v - U ) / a <br> 
      => t = ( ${vv} - ${vU} ) / ${va} <br> 
 ...
 else if(tt.checked  && vv==false )
 {
     ...
     math.innerHTML=`a object starts at a speed of ${vU} m/s <br>
       it is move with  ${va} m/s &#xb2 <br>
       and it is  travels ${vs} miter <br>
      at first I need to know V =?<br> <br> there ruls number 4 is <br>
      v &#xb2 = U &#xb2 + 2aS <br>
     => v&#xb2 = ${vU}&#xb2 + ( 2 ✕ ${va} ✕ ${vs} ) <br>
     => v&#xb2 = ${vU2} + ${v2as} <br>
     => v&#xb2 = ${vuas} <br>
...
phone.addEventListener("click", function(){
  ...
  email.style.boxShadow=shadoww;
  language.style.boxShadow=shadoww;
  scrn.innerHTML="01314456549 <br> 01722598399";
  scrn2.innerHTML="";
